...
$config = array(
	...
	|
	*/
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'].str_replace('/filemanager/dialog.php', '',$_SERVER['PHP_SELF']),
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	'upload_dir' => '/uploads/images/files/',
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	'current_path' => '../uploads/images/files/',
	...
	|
	*/
	'thumbs_base_path' => '../uploads/images/thumbs/',
